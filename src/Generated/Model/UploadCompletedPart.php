...
/**
 * UploadCompletedPart Class Doc Comment
 *
 * @category Class
 * @package  LeapOCRGenerated
 * @author   OpenAPI Generator team
 ...
 */
class UploadCompletedPart implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'upload.CompletedPart';
    ...
    */
    ...
    public function setEtag($etag)
    {
        ...
        if ((mb_strlen($etag) < 1)) {
            throw new \InvalidArgumentException('invalid length for $etag when calling UploadCompletedPart., must be bigger than or equal to 1.');
        }
    ...
    public function setPartNumber($part_number)
    {
        ...
        if (($part_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $part_number when calling UploadCompletedPart., must be bigger than or equal to 1.');
        }
